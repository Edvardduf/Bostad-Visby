    ...
    if (
      ...
      try {
        const response = await fetch(
          "http://localhost:8000/user/create", //add a dynamic url later
          {
            method: "POST",
            headers: {
          ...
          <div className="px-4 py-8 bg-white shadow sm:rounded-lg sm:px-10">
            <form className="space-y-6" onSubmit={submitRegister}>
              ...
              <div>
                <button
                  type="submit"
                  className="flex justify-center w-full px-6 py-3 text-sm font-medium text-white bg-green-600 border border-transparent rounded-md shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                >
                  Register
                </button>
              </div>
