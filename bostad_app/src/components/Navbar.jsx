    ...
    <nav className="bg-white px-4 py-4 flex justify-between items-center shadow">
      <div>
        ...
        <a href="/">
          ...
          >
            <g transform="matrix(1,0,0,1,-1.2121212121213603,0.9948029650253147)">
              <svg
                viewBox="0 0 396 172"
              ...
              >
                <g
                  id="tight-bounds"
                  transform="matrix(1,0,0,1,0.24000000000003752,-0.19712685482068082)"
                >
                  <svg
                    viewBox="0 0 395.5199999999999 172.39425370964136"
                    height="172.39425370964136"
                  ...
                  >
                    <g>
                      <svg
                        ...
                        width="395.5199999999999"
                      >
                        <g transform="matrix(1,0,0,1,0,106.54656490700867)">
                          <svg
                            viewBox="0 0 395.5199999999999 65.84768880263267"
                            height="65.84768880263267"
                            width="395.5199999999999"
                          >
                        ...
                        <g transform="matrix(1,0,0,1,112.446088195089,0)">
                          <svg
                            viewBox="0 0 170.62782360982192 91.00150592523836"
                          ...
                          >
                            <g>
                              ...
                              >
                                <polygon
                                  points="21,26 21,31 18,31 18,26 13,26 13,31 10,31 10,26 5,26 5,74 26,74 26,26 "
                                  fill="#000000"
                                  data-fill-palette-color="accent"
                                ></polygon>
                                <polygon
                                  points="90,26 90,31 87,31 87,26 82,26 82,31 79,31 79,26 74,26 74,74 95,74 95,26 "
                                  fill="#000000"
                                  data-fill-palette-color="accent"
                                ></polygon>
                                <path
                                  d="M65 33v5h-6v-5h-6v5h-6v-5h-6v5h-6v-5h-6v38h16V59c0-3.477 2.55-7.027 5-7.771 2.45 0.744 5 4.295 5 7.771v12h16V33H65z"
                                  fill="#000000"
                                  data-fill-palette-color="accent"
                                ></path>
                              </svg>
...
//    <div className="py-1">
//        <div className="px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Sök boende efter område</div>
//        {/* Add  4 alternatives here */}
//    </div>
//    <div className="py-1">
//        <div className="px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Sök boende efter veckor</div>
//        {/* Generate weeks 25 to 34 here*/}
//    </div>
//</div>
//)}
//</div>
